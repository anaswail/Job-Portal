...
const LandingPage = () => {
  return (
    <main className="flex flex-col gap-10 sm:gap-20 py-10 sm:py-20 max-sm:px-2">
      <section className="text-center">
        ...
        <p className="text-gray-300 sm:mt-4 text-xs sm:text-xl max-sm:mx-2 ">
      ...
      <Carousel className="w-full py-10" plugins={[Autoplay({ deplay: 2000 })]}>
